      ...
      >
        ...
        >
          <div class="menu-item">
            <a
              class="menu-link py-3"
              href="https://preview.abc.com/metronic8/vue/docs/#/utilities"
            >
              <span class="menu-icon">
          ...
          <div class="menu-item">
            <a
              class="menu-link py-3"
              href="https://preview.abc.com/metronic8/vue/docs/#/doc-overview"
            >
              <span class="menu-icon">
                <i
                  v-if="headerMenuIcons === 'font'"
          ...
          <div class="menu-item">
            <a
              class="menu-link py-3"
              href="https://preview.abc.com/metronic8/vue/docs/#/changelog"
            >
              <span class="menu-icon">
                <i
                  v-if="headerMenuIcons === 'font'"
